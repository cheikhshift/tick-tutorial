...
func webIndexTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/web/index.tmpl"
	name := "web/index.tmpl"
...
// webTickExampleTmpl reads file data from disk. It returns an error on failure.
func webTickExampleTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/web/tick/.example.tmpl"
	name := "web/tick/.example.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
func webYour404PageTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/web/your-404-page.tmpl"
...
func webYour500PageTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/web/your-500-page.tmpl"
...
// tmplTickRequestTmpl reads file data from disk. It returns an error on failure.
func tmplTickRequestTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/tmpl/tick/request.tmpl"
	name := "tmpl/tick/request.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// tmplTickTfuncTmpl reads file data from disk. It returns an error on failure.
func tmplTickTfuncTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/tmpl/tick/tfunc.tmpl"
	name := "tmpl/tick/tfunc.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// tmplTickWatchTmpl reads file data from disk. It returns an error on failure.
func tmplTickWatchTmpl() (*asset, error) {
	path := "/Users/Adrian/gosapphire/src/github.com/cheikhshift/tick-tutorial/tmpl/tick/watch.tmpl"
	name := "tmpl/tick/watch.tmpl"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
